...
// Start functions that will be called when the application start
displayTaskList();
// stop functions that will be called when the application start
